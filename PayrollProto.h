...
#pragma region Windows Form Designer generated code
		...
		void InitializeComponent(void)
		{
			...
			this->dataGridView1->Location = System::Drawing::Point(194, 23);
			this->dataGridView1->Name = L"dataGridView1";
			this->dataGridView1->Size = System::Drawing::Size(616, 379);
			...
			this->Menue->Size = System::Drawing::Size(94, 425);
			...
			this->ClientSize = System::Drawing::Size(822, 425);
			this->Controls->Add(this->Menue);
			this->Controls->Add(this->dataGridView1);
			this->Name = L"PayrollProtoDashboard";
			this->Text = L"PayrollProtoDashboard";
